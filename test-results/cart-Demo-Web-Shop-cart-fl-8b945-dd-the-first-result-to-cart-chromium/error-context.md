...
- Name: cart.spec.ts >> Demo Web Shop cart flow >> should search for a product and add the first result to cart
- Location: tests\specs\cart.spec.ts:13:3
...
- generic [ref=e1]:
  ...
  - list [ref=e379]:
    - generic [ref=e380]: Build your own cheap computer
    - generic [ref=e381]: Build your own computer
    - generic [ref=e382]: Build your own expensive computer
    - generic [ref=e383]: Simple Computer
```
