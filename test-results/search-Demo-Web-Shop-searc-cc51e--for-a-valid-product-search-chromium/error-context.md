...
- Name: search.spec.ts >> Demo Web Shop search >> should return results for a valid product search
- Location: tests\specs\search.spec.ts:11:3
...
Call log:
  - waiting for locator('button[type="submit"]').filter({ hasText: 'Search' })
...
- generic [ref=e1]:
        ...
        - list [ref=e10]:
          ...
          - listitem [ref=e19]:
            - link "Wishlist (0)" [ref=e20] [cursor=pointer]:
              ...
              - generic [ref=e22]: (0)
        - generic [ref=e24]:
          - status [ref=e25]: 4 results are available, use up and down arrow keys to navigate.
          - textbox [active] [ref=e26]: computer
              ...
              - generic [ref=e209]:
                - heading "14.1-inch Laptop" [level=2] [ref=e210]:
                  - link "14.1-inch Laptop" [ref=e211] [cursor=pointer]:
                    - /url: /141-inch-laptop
                - generic "1710 review(s)" [ref=e212]
                - generic [ref=e215]:
  ...
  - list [ref=e345]:
    - generic [ref=e346]: Build your own cheap computer
    - generic [ref=e347]: Build your own computer
    - generic [ref=e348]: Build your own expensive computer
    - generic [ref=e349]: Simple Computer
```
...
```ts
  ...
  5  |   readonly registerLink: Locator;
  ...
  12 |     this.page = page;
  13 |     this.registerLink = page.locator('a', { hasText: 'Register' });
  14 |     this.loginLink = page.locator('a', { hasText: 'Log in' });
  15 |     this.searchInput = page.locator('#small-searchterms');
  16 |     this.searchButton = page.locator('button[type="submit"]', { hasText: 'Search' });
  17 |     this.cartLink = page.locator('a', { hasText: 'Shopping cart' });
  18 |   }
  19 | 
  20 |   async goto() {
  ...
  22 |   }
  23 | 
  24 |   async navigateToRegister() {
  25 |     await this.registerLink.click();
  26 |   }
  27 | 
  28 |   async navigateToLogin() {
  29 |     await this.loginLink.click();
  30 |   }
  31 | 
  32 |   async navigateToCart() {
  33 |     await this.cartLink.click();
  34 |   }
  35 | 
  36 |   async search(term: string) {
